...
def get_common_mentors(courses, mentors):
    mentors_names = []
    for m in mentors:
    ...
    for id1 in range(len(mentors_names)):
        for id2 in range(id1 + 1, len(mentors_names)):
            ...
            if len(intersection_set) > 0:
                ...
                common_names_sorted = sorted(intersection_set)
                print(f"На курсах '{courses[id1]}' и '{courses[id2]}' преподают: {', '.join(common_names_sorted)}")
    return pairs, common_names_sorted
